...
public class ProvinceResource {
    ...
    private void initilize() {
        ...
        Province p1 = new Province(41, prov1, 5); //41 por el codigo postal
        Province p2 = new Province(06, prov2, 4); //06 por el cofigo postal
        provinceMap.put(prov1, p1);
        provinceMap.put(prov2, p2);
    }

	public List<Province> getAllProvinces() {
		return new ArrayList(this.provinceMap.values());
	}
